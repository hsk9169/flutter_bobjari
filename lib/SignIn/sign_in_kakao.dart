...
class SignInKakaoScreen extends StatefulWidget {
  const SignInKakaoScreen({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _SignInKakaoScreen();
}

class _SignInKakaoScreen extends State<SignInKakaoScreen> {
