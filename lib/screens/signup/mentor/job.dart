...
class SignupMentorJobView extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _SignupMentorJobView();
}

class _SignupMentorJobView extends State<SignupMentorJobView> {
  ...
  void _pressNext(bool isValue) {
    if (isValue) {
      Provider.of<Signup>(context, listen: false).job = _job;
    }
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => SignupMentorCompanyView()));
  }
    ...
    return SignupForm(
        ...
        child: Column(children: [
          GestureDetector(
              ...
              child: Container(
                  decoration: BoxDecoration(
                      border: Border.all(
                          color: _job == '' ? BobColors.mainColor : Colors.grey,
                          width: 2),
                      borderRadius: BorderRadius.circular(30)),
                  width: MediaQuery.of(context).size.width,
          ...
          Container(
              ...
              child: _job != '' ? renderChip() : null)
        ]),
        topTitle: const ['현재 직업이 무엇인가요?', ''],
        btn1Title: '다음',
        btn1Color: BobColors.mainColor,
        pressBack: _pressBack,
        pressBtn1: _job == '' ? null : () => _pressNext(true),
        btn2Title: '나중에 하기',
                        ...
                        (idx) => GestureDetector(
                            ...
                            onTapUp: (details) {
                              Future.delayed(const Duration(milliseconds: 100),
                                ...
                                _selected.value = -1;
                                setState(() {
                                  _job = _suggestionList.value[idx];
                                });
                                Navigator.pop(context);
                              });
                            },
